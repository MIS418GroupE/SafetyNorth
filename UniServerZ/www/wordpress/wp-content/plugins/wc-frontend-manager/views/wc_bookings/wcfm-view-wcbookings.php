...
$wcfmu_bookings_menus = apply_filters( 'wcfmu_bookings_menus', array( 'all' => __( 'All', 'wc-frontend-manager-ultimate'), 
																																			'complete' => __('Complete', 'wc-frontend-manager-ultimate' ), 
																																			'paid' => __('Paid & Confirmed', 'wc-frontend-manager-ultimate' ),
...
<div class="collapse wcfm-collapse" id="wcfm_bookings_listing">
  <div class="wcfm-page-headig">
		...
		<span class="wcfm-page-heading-text"><?php _e( 'Bookings List', 'wc-frontend-manager-ultimate' ); ?></span>
	...
	<div class="wcfm-collapse-content">
	  <div id="wcfm_page_load"></div>
		...
		<?php
		do_action( 'before_wcfm_bookings' );
		
		if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) {
			?>
			<a class="wcfm_screen_manager text_tip" href="#" data-screen="booking" data-tip="<?php _e( 'Screen Manager', 'wc-frontend-manager-ultimate' ); ?>"><span class="fa fa-television"></span></a>
			<a target="_blank" class="wcfm_wp_admin_view text_tip" href="<?php echo admin_url('edit.php?post_type=wc_booking'); ?>" data-tip="<?php _e( 'WP Admin View', 'wc-frontend-manager-ultimate' ); ?>"><span class="fa fa-wordpress"></span></a>
			<?php
		}
				...
				<table id="wcfm-bookings" class="display" cellspacing="0" width="100%">
					<thead>
						<tr>
							...
							<th><?php _e( 'Booking', 'wc-frontend-manager-ultimate' ); ?></th>
