		...
		<div class="wcfm-container">
			<div id="bookings_details_booking_expander" class="wcfm-content">
				...
				<p class="form-field form-field-wide">
					...
					<?php echo apply_filters( 'wcfm_booking_start_date', date( 'Y-m-d H:i A', $booking->get_start( 'edit' ) ), $booking ); ?>
				</p>
				
				<p class="form-field form-field-wide">
					<label for="booking_date"><?php _e( 'Booking End Date:', 'woocommerce-bookings' ) ?></label>
					<?php echo apply_filters( 'wcfm_booking_end_date', date( 'Y-m-d H:i A', $booking->get_end( 'edit' ) ), $booking ); ?>
				</p>
				<p class="form-field form-field-wide">
