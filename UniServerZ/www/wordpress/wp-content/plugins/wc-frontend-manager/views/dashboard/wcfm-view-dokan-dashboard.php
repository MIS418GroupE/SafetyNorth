				...
				<div class="wcfm_dashboard_welcome_container">
					<div class="wcfm_dashboard_welcome_content">
						<?php
							...
							$previous_login = get_user_meta( $current_user_id, '_previous_login', true );
						?>
				...
				<div class="wcfm_dashboard_stats_block">
					<a href="<?php echo apply_filters( 'sales_by_product_report_url', get_wcfm_reports_url( ), '' ); ?>">
					  <span class="fa fa-cubes"></span>
						<div>
							<?php printf( _n( "<strong>%s item</strong><br />", "<strong>%s items</strong><br />", $report_data->total_items, 'wc-frontend-manager' ), $report_data->total_items ); ?>
