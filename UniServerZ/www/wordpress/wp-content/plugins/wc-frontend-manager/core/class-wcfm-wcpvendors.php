  	...
  	$qty = ( isset( $item['qty'] ) ? esc_html( $item['qty'] ) : '1' );
		...
		?>
			...
			<td class="line_cost no_ipad no_mob" width="1%">
				<div class="view"><?php echo wc_price( $order_line_due[0]->product_shipping_amount ); ?></div>
			</td>
			...
			<td class="line_cost shipping_tax_cost no_ipad no_mob">
				<div class="view"><?php echo wc_price( $order_line_due[0]->product_shipping_tax_amount ); ?></div>
			</td>
		<?php
		} else {
			?>
  ...
  function wcpvendors_order_total_commission( $order_id ) {
    ...
    $order_due = $wpdb->get_results( $sql );
		...
		<tr>
			...
			<td class="total">
				<div class="view"><?php echo wc_price( $order_due[0]->shipping_tax ); ?></div>
			</td>
		</tr>
		<tr>
