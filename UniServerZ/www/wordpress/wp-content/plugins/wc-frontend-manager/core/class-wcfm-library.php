  ...
  public $views_path;
	...
	public function load_views( $end_point, $menu = true ) {
      ...
      case 'wcfm-orders-details':
      	if( WCFM_Dependencies::wcfm_wc_dhl_shipping_active_check() ) {
        	require_once( $this->views_path . 'wcfm-view-orders-details-dhl-express.php' );
        }
	...
	*/
	public function load_upload_lib() {
	  ...
	  $uploads_language = array( "choose_media" => __( 'Choose Media', 'wc-frontend-manager' ), "choose_image" => __( 'Choose Image', 'wc-frontend-manager' ) );
