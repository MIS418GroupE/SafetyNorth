	...
	$( document.body ).on( 'wcfm_form_validate', function() {
		...
		$('[data-required="1"]').each(function() {
			...
			if( $.inArray( $data_name, $proccessed_required_fileds ) === -1 ) {
				...
				if( !$(this).parents('.wcfm-container').hasClass('wcfm_block_hide') && !$(this).parent().parent().hasClass('wcfm_block_hide') && !$(this).parent().parent().hasClass('wcfm_custom_hide') && !$(this).parent().hasClass('wcfm_block_hide') && !$(this).parent().hasClass('wcfm_custom_hide') && !$(this).hasClass('wcfm_ele_hide') && !$(this).hasClass('wcfm_custom_hide') ) {
